        ...
        container.innerHTML += `
            <div class="row-item">
                ...
                <div class="text-center">
                    <input type="number" id="qty-${law.id}" value="${itemQtys[law.id] || 0}" min="0" onchange="updateQty('${law.id}')" style="width: 50px;">
                </div>
            </div>
        `;
    });
...
function updateQty(id) {
    itemQtys[id] = parseInt(document.getElementById(`qty-${id}`).value) || 0;
    calculate();
}
